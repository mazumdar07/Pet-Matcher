...
import 'package:petMatcher/category_list.dart';
import 'package:petMatcher/data.dart';
import 'package:petMatcher/pet_widget.dart';
          ...
          children: [
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      buildPetCategory(Category.Bird, "56", Colors.orange[200]),
            ...
            Container(
              ...
              child: PageView(
                physics: BouncingScrollPhysics(),
                children: [
                  buildVet("assets/images/vets/download.png",
                      "Animal Emergency Hospital", "(369) 133-8956"),
                  buildVet("assets/images/vets/vet2.jpg",
                ...
                children: [
                  Text(
                    category == Category.Bird
                        ...
                        : category == Category.CAT
                            ? "Cat"
                            : category == Category.BUNNY ? "Bunny" : "Dog",
                    style: TextStyle(
                      color: Colors.grey[800],
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
